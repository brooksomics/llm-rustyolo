...
fn main() {
    ...
    let mut trusted_domains = cli.allow_domains.unwrap_or_default();
    ...
    let auth_home_path = cli.auth_home.unwrap_or(default_auth_home);
